"""
F-Dataset 三段式 Hard Negative Mining (论文严格实现)
 输入: results/MiRAGE_score_F.csv (18 维特征)
 输出: data/F-Dataset/Evaluation/train.csv + test.csv
"""
import pandas as pd
import numpy as np
import os
...
# 配置
# ================================================================
INPUT_FILE = r"code\results\MiRAGE_score_F.csv"
OUTPUT_TRAIN = r"data/F-Dataset/Evaluation/train.csv"
OUTPUT_TEST  = r"data/F-Dataset/Evaluation/test.csv"
...
def main():
    print("=" * 60)
    print(" F-Dataset 三段式 Hard Negative Mining")
    print("=" * 60)
